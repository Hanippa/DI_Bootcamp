...
//the index, the map function loops through the array. i will be 0 then 1 , 2 ,3 , 4 , 5
...
const reducedarray = array.flat(Infinity);

const greeting = [["Hello", "young", "grasshopper!"], ["you", "are"], ["learning", "fast!"]];

reducedgreeting = greeting.reduce((a , b) => a.reduce((a , b) => a+b) + b.reduce((a , b) => a+b))

const trapped = [[[[[[[[[[[[[[[[[[[[[[[[[[3]]]]]]]]]]]]]]]]]]]]]]]]]] 
const reducedtrapped = trapped.flat(Infinity)