...
INSERT INTO students(first_name , last_name , birth_date) VALUES ('Dekel','Matslich','1990-01-01');
...
SELECT first_name, last_name , birth_date FROM students ORDER BY birth_date LIMIT 1;
