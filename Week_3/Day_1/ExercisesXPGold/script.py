...
class MyList:
    ...
    def reverse(self):
        letter_list_temp = self.letter_list
        letter_list_temp.reverse()
        return letter_list_temp
    def new_list(self):
        new_list = [random.choice(string.ascii_letters) for x in self.letter_list]
        return new_list
mylist = MyList(["A","Z","C","Z"])
print(mylist.sort())
