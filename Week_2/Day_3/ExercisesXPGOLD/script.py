...
birthdays = {"chase" : "10/10/2000" , "tricia" : "10/11/1995" , "nick" : "09/03/2001" , "britt" : "12/12/2009", "valary" : "01/02/1990"}
print("Welcome!, you can look up the birthdays of people in the list!")
print(birthdays.keys())

print("Please add your own birthday to the list!")
...
if user_input in birthdays:
    ...
    print(f"{user_input} is not on the list:( please try again)")
...
for i in items:
    print(f"We have {i}s for {items[i]} dollars ")
...
stock_price = 0
for i in items:
    stock_price += items[i]["price"]
print(f"You can buy everything in stock for {stock_price} dollars")